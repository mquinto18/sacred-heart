...
<div class="container-fluid bg-dark">
  ...
  <div class="collapse navbar-collapse" id="mainNav">
    ...
    <ul class="navbar-nav d-flex justify-content-center w-100">
      ...
      <!-- About Link -->
      <li class="nav-item">
        <a href="#aboutscroll" class="aboutbutton nav-link text-light fs-7" style="font-family: Poppins;" disabled>About</a>
      </li>
      <!-- Contact Link -->
      <li class="nav-item">
        <a href="#contactside" class="nav-link text-light fs-7" style="font-family: Poppins;" disabled>Contact</a> 
      </li>
      <!-- Announcement -->
      <li class="nav-item">
