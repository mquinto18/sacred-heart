...
<div class="modal fade" id="modalWeddingDates" aria-hidden="true" tabindex="-1">
...
footer: '<a href=\"wedding?month=" . date('m') . "&year=" . date('Y') . "\" type=\"button\" id=\"swal-success\">info</a>'
});
}); 
</script>";
